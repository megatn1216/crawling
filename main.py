...
class Window(QWidget):
    ...
    def btn1_clicked(self):
        ...
        ##### 임시코드
        temp_path ='C:/Users/jagua/Desktop/Crawling_oor/crawling/(2021_10_19)_idea_엑셀추출 (1).xlsx'
        ...
        for brand in brandList:
            ...
            data[brand].cell(1, maxC+1).value = 'price_'+strtime #행 추가 시 컬럼명 지정
            data[brand].cell(1, maxC+2).value = 'stock_'+strtime #행 추가 시 컬럼명 지정
